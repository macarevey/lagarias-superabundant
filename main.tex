...
\]
By \eqref{lem:lower_bounds}, $H'(x) \geq \frac{1}{x+1} > 0$ for $x \geq 1$, so $H(x)$ is increasing on $[1, \infty)$. Since $H(1) = 1$, it follows that $H(x) \geq 1$ for all $x \geq 1$, hence $\log(H(x)) \geq 0$. Therefore
\[
